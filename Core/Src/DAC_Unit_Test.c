...
uint8_t unit_test_Config_Register_Default(struct sDAC *s){
    ...
    return unit_test_Default_Values(s,Config_Register, Default_Value);
}
...
uint8_t unit_test_ANALOG_MONITOR_SELECT_Register_Default(struct sDAC *s){
    ...
    return unit_test_Default_Values(s,DAC_Register, Default_Value);
}
...
uint8_t unit_test_Default_Values_All_Registers(struct sDAC *s){
    uint8_t result = 0;
    result += unit_test_Config_Register_Default(s);
    result += unit_test_ANALOG_MONITOR_SELECT_Register_Default(s);
    result += unit_test_GPIO_Register_Default(s);
    result += unit_test_OFFSET_A_Default(s);
    result += unit_test_OFFSET_B_Default(s);
    result += unit_test_BROADCAST_Default(s);
    result += unit_test_SPI_MODE_Default(s);
    result += unit_test_DAC_0_Default(s);
    result += unit_test_DAC_1_Default(s);
    result += unit_test_DAC_2_Default(s);
    result += unit_test_DAC_3_Default(s);
    result += unit_test_DAC_4_Default(s);
    result += unit_test_DAC_5_Default(s);
    result += unit_test_DAC_6_Default(s);
    result += unit_test_DAC_7_Default(s);
    result += unit_test_ZERO_0_Default(s);
    result += unit_test_ZERO_1_Default(s);
    result += unit_test_ZERO_2_Default(s);
    result += unit_test_ZERO_3_Default(s);
    result += unit_test_ZERO_4_Default(s);
    result += unit_test_ZERO_5_Default(s);
    result += unit_test_ZERO_6_Default(s);
    result += unit_test_ZERO_7_Default(s);
    result += unit_test_GAIN_0_Default(s);
    result += unit_test_GAIN_1_Default(s);
    result += unit_test_GAIN_2_Default(s);
    result += unit_test_GAIN_3_Default(s);
    result += unit_test_GAIN_4_Default(s);
    result += unit_test_GAIN_5_Default(s);
    result += unit_test_GAIN_6_Default(s);
    result += unit_test_GAIN_7_Default(s);
    return result;
}
